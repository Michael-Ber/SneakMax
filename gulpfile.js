...
gulp.task("styles", () => {
  return gulp.src("./src/assets/sass/*.scss", { sourcemaps: !isProd })
    .pipe(plumber(
      notify.onError({
        title: "SCSS",
...
gulp.task("default", gulp.series("clean", "html-include", "scripts", "styles", "resources", "images", "webp", "svgSprites", "watch"));

gulp.task("build", gulp.series(toProd, "clean", "html-include", "scripts", "styles", "resources", "images", "webp", "svgSprites", "html-minify"));

gulp.task("cache", gulp.series("cacheFiles", "revrite"))

gulp.task("backend", gulp.series(toProd, "clean", "html-include", "scriptsBackend", "stylesBackend", "resources", "images", "webp", "svgSprites"));